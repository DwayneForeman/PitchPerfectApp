...
//  PitchPerfect
//
//  Created by MyMac on 2/2/21.
//  Copyright © 2021 AppWithThat. All rights reserved.
//
...
class PlaySoundsViewController: UIViewController {
    ...
    // Enum use to list similar var/let which will have a prupose
    enum ButtonType: Int {
    ...
    @IBAction func playSoundForButton(_ sender: UIButton) {
        ...
        // Switch used to grab list from enum and give the var an action
    ...
    override func viewDidLoad() {
        ...
        // MARK: - Setting imageView property of image to scaleAspectFit
